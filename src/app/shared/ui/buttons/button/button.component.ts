...
export class ButtonComponent {
  ...
  readonly variants: Record<string, Record<string, string[]>> = {
    ...
    gray: {
      ...
      soft: ['text-gray-700', 'bg-gray-600/5', 'hover:bg-gray-600/15', 'active:bg-gray-600/20', 'disabled:bg-gray-600/5'],
      ghost: ['text-gray-700', 'bg-transparent', 'hover:bg-gray-600/5', 'active:text-gray-800', 'active:bg-gray-600/15', 'focus:text-gray-800', 'disabled:text-gray-700', 'disabled:bg-transparent']
    },
    red: {
      solid: ['text-red-100', 'bg-red-700', 'hover:bg-red-800', 'active:bg-red-900', 'active:ring-2', 'active:ring-red-100', 'focus:ring-2', 'focus:ring-red-100', 'disabled:bg-red-700', 'disabled:ring-2', 'disabled:ring-red-100'],
      soft: ['text-red-700', 'bg-red-100', 'hover:bg-red-200', 'active:bg-red-300', 'disabled:bg-red-100'],
      ghost: ['text-red-700', 'bg-transparent', 'hover:bg-red-200', 'active:bg-red-300', 'disabled:bg-transparent']
    },
    green: {
      solid: ['text-green-100', 'bg-green-800', 'hover:bg-green-700', 'active:bg-green-900', 'active:ring-2', 'active:ring-green-100', 'focus:ring-2', 'focus:ring-green-100', 'disabled:bg-green-800', 'disabled:ring-2', 'disabled:ring-green-100'],
      soft: ['text-green-800', 'bg-green-100', 'hover:bg-green-300', 'active:bg-green-500', 'disabled:bg-green-100'],
      ghost: ['text-green-800', 'bg-transparent', 'hover:bg-green-300', 'active:bg-green-500', 'disabled:bg-transparent']
    },
  };
